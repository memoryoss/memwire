...
Most memory solutions store a flat list of strings and retrieve them by cosine similarity. MemWire instead builds a **graph of token-level nodes** where edges encode semantic displacement relationships between tokens across memories.
