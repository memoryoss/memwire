...
All queries — recall, search, and knowledge — are automatically scoped to the identifiers you pass. No cross-tenant data leaks are possible because every Qdrant filter and SQL index is keyed on this hierarchy.
